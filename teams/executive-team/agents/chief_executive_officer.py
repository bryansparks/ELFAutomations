...
class ChiefExecutiveOfficerAgent:
    ...
    async def send_strategic_directive(self, executive_role: str, directive: str, 
                                     objectives: List[str], deadline: Optional[str] = None,
        ...
        self.log_communication(f"Strategic directive to {executive_role}: {directive}", executive_role)
