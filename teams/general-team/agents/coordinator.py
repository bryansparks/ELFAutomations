"""
Coordinator Agent for general-team
"""
...
def coordinator(
    ...
    backstory = """You are the Coordinator for general-team.
    ...
    if enable_evolution:
        try:
            ...
            if evolved_config and evolved_config.evolved_prompt:
                ...
                logger.info(f"Loaded evolved prompt for Coordinator (confidence: {evolved_config.confidence_score})")
