...
# Import team members
from agents import ManagerwithA2AAgent
from agents import ValidationSpecialistAgent
from agents import MonitoringSpecialistAgent
from agents import ResilienceEngineerAgent
from agents import RegistrySpecialistAgent
...
class N8NInterfaceTeamCrew:
    ...
    def _create_crew(self) -> Crew:
        ...
        return Crew(
            ...
            verbose=True,
            memory=True,
            manager_llm=self.manager_with_a2a.llm if process == Process.hierarchical else None,
