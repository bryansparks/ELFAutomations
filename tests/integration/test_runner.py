...
class TestSuite:
    ...
    def add_result(self, name: str, status: TestStatus, duration: float, 
    ...
    async def run_all_tests(self) -> bool:
        ...
        for suite in self.suites:
            ...
            try:
                ...
                self.print_test_result(TestResult(
...
async def check_http_endpoint(url: str, timeout: int = 10, 
...
async def wait_for_condition(condition_func, timeout: int = 60, 
                           interval: int = 2) -> bool:
