...
from agents.langgraph_base import LangGraphBaseAgent, AgentGatewayClient, AgentLifecycleState
...
class TestLangGraphFoundation:
    ...
    def demo_agent(self, mock_gateway_client):
        ...
        with patch('agents.langgraph_base.AgentGatewayClient', return_value=mock_gateway_client):
            agent = DemoAgent(
    ...
    async def test_langgraph_workflow(self, demo_agent):
        ...
        with patch('agents.langgraph_base.ChatAnthropic') as mock_llm:
            mock_llm.return_value.ainvoke = AsyncMock(return_value=Mock(
                content="Test response from LangGraph workflow"
            ))
    ...
    def test_factory_function(self):
        ...
        with patch('agents.langgraph_base.AgentGatewayClient'):
            agent = create_demo_agent(
                ...
                gateway_url="https://test.gateway.dev"
            )
...
class TestKagentIntegration:
    ...
    def test_kagent_crd_structure(self):
        ...
        crd = next(doc for doc in crd_docs if doc.get('kind') == 'CustomResourceDefinition')
        ...
        required_fields = crd['spec']['versions'][0]['schema']['openAPIV3Schema']['properties']['spec']['required']
    ...
    def test_demo_agent_manifest(self):
        ...
        manifest_path = "/Users/bryansparks/projects/ELFAutomations/k8s/staging/demo-agent.yaml"
        
        with open(manifest_path, 'r') as f:
            docs = list(yaml.safe_load_all(f))
        
        # Find the LangGraphAgent resource
        agent_resource = next(doc for doc in docs if doc.get('kind') == 'LangGraphAgent')
        ...
        business_tools = next(
            server for server in spec['mcpTools'] 
...
class TestTechnologyStackCompliance:
    ...
    def test_langgraph_dependency(self):
        ...
        requirements_path = "/Users/bryansparks/projects/ELFAutomations/requirements.txt"
    ...
    def test_mcp_protocol_compliance(self):
        ...
        base_agent_path = "/Users/bryansparks/projects/ELFAutomations/agents/langgraph_base.py"
    ...
    def test_agentgateway_mandatory_usage(self):
        ...
        demo_agent_path = "/Users/bryansparks/projects/ELFAutomations/agents/demo_agent.py"
...
async def test_full_demo_integration():
    ...
    with patch('agents.langgraph_base.AgentGatewayClient'):
        ...
        with patch('agents.demo_agent.DemoAgent') as mock_agent_class:
            ...
            mock_agent.test_mcp_integration = AsyncMock(return_value={"available_tools": []})
            mock_agent.validate_infrastructure = AsyncMock(return_value={"overall_status": "passed"})
            mock_agent.get_health_check = Mock(return_value=Mock(
                agent_id="test",
