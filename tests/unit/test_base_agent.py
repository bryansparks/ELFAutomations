...
from agents.base import AgentConfig, AgentStatus, AgentType, BaseAgent
...
class TestBaseAgent:
    ...
    async def test_task_execution(self, test_agent):
        """Test task execution."""
        task = {"id": "test-task-001", "type": "test_task", "description": "Test task"}
    ...
    async def test_task_execution_error(self, test_agent):
        ...
        with patch.object(
            test_agent, "_execute_task_impl", side_effect=Exception("Test error")
        ):
