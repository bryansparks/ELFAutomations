...
async def test_basic_registry_operations():
    ...
    members = [
        ("marketing_manager", "Marketing Manager", ["marketing_strategy", "team_leadership", "campaign_planning"], True),
        ("content_writer", "Content Writer", ["content_creation", "copywriting", "blog_writing"], False),
        ("social_media_specialist", "Social Media Specialist", ["social_media", "content_creation", "analytics"], False),
    ]
...
async def test_registry_tools():
    ...
    capabilities_json = json.dumps(["content_creation", "social_media", "marketing_strategy"])
