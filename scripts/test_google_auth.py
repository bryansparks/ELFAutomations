...
def check_google_credentials():
    ...
    if not client_id or not client_secret:
        ...
        console.print("   - APIs & Services > Library > Search 'Google Drive API' > Enable")
        ...
        console.print("   - Add authorized redirect URI: http://localhost:8080/oauth2callback")
...
def main():
    ...
    if creds_ok:
        ...
        if auth_ok:
            ...
            console.print("pip install google-auth google-auth-oauthlib google-auth-httplib2 google-api-python-client")
            return 1
    else:
        return 1
