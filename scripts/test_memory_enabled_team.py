...
from elf_automations.shared.memory import TeamMemory, LearningSystem
    ...
    tasks = [
        {
            ...
            "agent_contributions": {
                ...
                "Data Analyst": ["Collected data from 50 sources", "Created visualizations"],
        ...
        },
        {
            ...
            "agent_contributions": {
                ...
                "Technical Writer": ["Compiled research report", "Created infographics"]
            }
        },
        {
            ...
            "success": False,
            "duration": 200,
            "error": {"type": "DataInsufficient", "message": "Not enough public data available"},
            "agent_contributions": {
