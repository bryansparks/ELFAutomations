            ...
            async with ClientSession(read, write) as session:
                ...
                if "execute_sql" in tool_names:
                    ...
                    result = await session.call_tool(
                        "execute_sql",
                        arguments={"project_id": project_ref, "query": sql_content},
                    )
                    ...
                    result = await session.call_tool(
                        "apply_migration",
                        arguments={"project_id": project_ref, "sql": sql_content},
                    )
                ...
                result = await session.call_tool(
                    "execute_sql",
                    arguments={"project_id": project_ref, "query": verification_query},
                )
                ...
                result = await session.call_tool(
                    "execute_sql",
                    arguments={"project_id": project_ref, "query": insert_query},
                )
