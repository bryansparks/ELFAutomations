...
from ..registry.client import Team, TeamHierarchy, TeamRegistryClient
    ...
    def _run(self, capability: str) -> str:
        ...
        try:
            ...
            for team in teams:
                ...
                members_with_cap = [
                    m for m in team.members if capability in m.capabilities
                ]
    ...
    def _run(self, update_json: str) -> str:
        ...
        try:
            ...
            try:
                ...
                if not all(
                    k in update_data
                    for k in ["team_name", "agent_name", "capabilities"]
                ):
