"""
Monitoring Specialist Agent for n8n-interface-team
"""
...
def execution_tracker(
    ...
    """
    Monitoring Specialist implementation
    ...
    Skills: n8n API, Supabase, monitoring, alerting, performance tracking
    ...
    backstory = """You are the Monitoring Specialist for n8n-interface-team.
    ...
    if enable_evolution:
        try:
            ...
            base_config = {
                ...
                "goal": "Monitors n8n workflow executions in real-time. Updates Supabase with execution status and progress",
                "backstory": backstory,
            ...
            if evolved_config and evolved_config.evolved_prompt:
                ...
                logger.info(
                    f"Loaded evolved prompt for Monitoring Specialist (confidence: {evolved_config.confidence_score})"
                )
