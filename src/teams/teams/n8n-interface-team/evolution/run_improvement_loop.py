#!/usr/bin/env python3
"""
Improvement Loop for n8n-interface-team
...
def run_improvement_cycle():
    ...
    logger.info("Starting improvement cycle for n8n-interface-team")
    ...
    try:
        ...
        improvement_loop = ImprovementLoop(
            supabase=supabase, improvement_frequency="daily"
        )
        ...
        team_memory = TeamMemory(
            team_id=team_id, supabase_client=supabase, retention_days=30
        )
        ...
        logger.info(
            f"  - Success rate improvement: {results.get('avg_improvement', 0):.1%}"
        )
