"""
Team Lead Agent for general-team
"""
...
def team_lead(
    ...
    backstory = """You are the Team Lead for general-team.
    ...
    if enable_evolution:
        try:
            ...
            evolved_config = loader.load_evolved_agent_config(
                team_id="general-team", agent_role="Team Lead", base_config=base_config
            )
            ...
            if evolved_config and evolved_config.evolved_prompt:
                ...
                logger.info(
                    f"Loaded evolved prompt for Team Lead (confidence: {evolved_config.confidence_score})"
                )
