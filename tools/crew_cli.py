...
class CrewCLI:
    ...
    def create_team(self, team_name: str, department: str, agents: List[str], 
                   description: str = "", namespace: str = "elf-automations") -> Dict:
        ...
        if self.crews_dir.exists():
            for team_file in self.crews_dir.glob("*.yaml"):
                with open(team_file, 'r') as f:
                    ...
                    department = config['metadata']['labels'].get('department', 'unknown')
...
def main():
    ...
    create_parser.add_argument('--executive', action='store_true', 
                             help='Create the Executive Team')
