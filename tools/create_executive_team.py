...
from tools.team_factory import TeamFactory, TeamSpecification, TeamMember
...
def create_executive_team():
    ...
    executive_team = TeamSpecification(
        ...
        communication_pattern={
            "Chief Executive Officer": ["Chief Technology Officer", "Chief Marketing Officer", "Chief Operations Officer", "Chief Financial Officer"],
            "Chief Technology Officer": ["Chief Executive Officer", "Chief Operations Officer", "Chief Marketing Officer"],
            "Chief Marketing Officer": ["Chief Executive Officer", "Chief Technology Officer", "Chief Financial Officer"],
            "Chief Operations Officer": ["Chief Executive Officer", "Chief Technology Officer", "Chief Financial Officer"],
            "Chief Financial Officer": ["Chief Executive Officer", "Chief Marketing Officer", "Chief Operations Officer"]
        },
