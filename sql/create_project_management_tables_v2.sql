...
-- Drop existing objects to ensure clean creation (comment these out if you want to preserve data)
-- DROP VIEW IF EXISTS available_tasks_for_assignment CASCADE;
-- DROP VIEW IF EXISTS project_dashboard CASCADE;
-- DROP VIEW IF EXISTS team_active_tasks CASCADE;
-- DROP TABLE IF EXISTS task_skill_matches CASCADE;
...
DROP TRIGGER IF EXISTS trigger_task_ready_check ON tasks;
...
DROP TRIGGER IF EXISTS trigger_project_progress_update ON tasks;
