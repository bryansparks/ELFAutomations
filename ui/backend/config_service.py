...
class ConfigService:
    ...
    def update_agent(self, name: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if validated_config.metadata["name"] != name:
            raise ConfigValidationError("Agent name in configuration must match URL parameter")
    ...
    def update_crew(self, name: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Ensure name matches
        if validated_config.metadata["name"] != name:
            raise ConfigValidationError("Crew name in configuration must match URL parameter")
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        ...
        return {
            "agents": {
                "total": len(agents),
                "by_department": {dept: len([a for a in agents if a.get("_department") == dept]) for dept in departments}
            },
            "crews": {
                "total": len(crews)
            },
