...
app = FastAPI(
    ...
    description="A2A-enabled CrewAI team for Executive leadership team with CEO, CTO, CMO, CFO",
    version="1.0.0"
)
...
class HealthResponse(BaseModel):
    ...
    timestamp: str
    agents: List[str] = ['Chief Executive Officer', 'Chief Technology Officer', 'Chief Marketing Officer', 'Chief Operating Officer', 'Chief Financial Officer', 'Chief Product Officer']
...
async def startup_event():
    ...
    a2a_server = A2AServer(
        ...
        capabilities=[
            "Executive leadership team with CEO, CTO, CMO, CFO",
            "Task execution",
            "Status reporting",
            "Team coordination"
        ]
...
async def get_capabilities():
    ...
    return {
        ...
        "agents": [
            {
                "role": agent,
                "is_manager": agent == "Chief Executive Officer"
            }
            for agent in ['Chief Executive Officer', 'Chief Technology Officer', 'Chief Marketing Officer', 'Chief Operating Officer', 'Chief Financial Officer', 'Chief Product Officer']
        ],
        "capabilities": [
            "Executive leadership team with CEO, CTO, CMO, CFO",
...
async def get_status():
    ...
    return {
        ...
        "agents_status": {
            agent: "ready" for agent in ['Chief Executive Officer', 'Chief Technology Officer', 'Chief Marketing Officer', 'Chief Operating Officer', 'Chief Financial Officer', 'Chief Product Officer']
        }
    }
