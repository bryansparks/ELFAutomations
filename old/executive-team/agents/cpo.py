"""
Chief Product Officer Agent for general-team
"""
...
def cpo(
    ...
    """
    Chief Product Officer implementation

    Responsibilities:
    - Ultimately owns all products in terms of features, user experience, and function. Works closely with the CTO on architecture and very closely with Engineering Management.

    Skills: 

    Personality Traits: collaborator
    """
    ...
    backstory = """You are the Chief Product Officer for general-team.
...
You build consensus and foster team unity."""
    ...
    agent = Agent(
        ...
        goal="Ultimately owns all products in terms of features, user experience, and function. Works closely with the CTO on architecture and very closely with Engineering Management.",
        backstory=backstory,
