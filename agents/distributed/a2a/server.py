...
from a2a.types import AgentCard, AgentCapabilities, AgentSkill, Message, Task, Part, TextPart, Role

# CrewAI imports
from crewai import Agent, Task as CrewAITask, Crew
...
class A2AServerManager:
    ...
    def __init__(self, agent_card: AgentCard, crewai_agent: Agent, host: str = "0.0.0.0", port: int = 8090):
        """
...
async def create_a2a_server(agent_card: AgentCard, crewai_agent: Agent, host: str = "0.0.0.0", port: int = 8090) -> A2AServerManager:
    """
